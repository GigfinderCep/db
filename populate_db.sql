v-- Insert Users (3 Musicians, 3 Locals)
INSERT INTO dbo.Users (name, description, email, password, type, avg_rating)
VALUES 
('John Doe', 'A talented guitarist and singer.', 'johndoe@example.com', 'test', 'music', 4),
('Alice Smith', 'An amazing violinist with classical roots.', 'alicesmith@example.com', 'test', 'music', 5),
('Mike Johnson', 'A drummer specializing in jazz and rock.', 'mikejohnson@example.com', 'test', 'music', 3),
('The Grand Hall', 'A spacious venue for large events.', 'grandhall@example.com', 'test', 'local', 5),
('Downtown Pub', 'A cozy spot for live performances.', 'downtownpub@example.com', 'test', 'local', 4),
('Skyline Club', 'A high-energy nightclub with live DJs.', 'skylineclub@example.com', 'test', 'local', 3);
